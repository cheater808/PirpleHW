...
def addToList(newthing):
    if newthing in myUniqueList:
        addToLeftovers(newthing)
        return False
    else:
        myUniqueList.append(newthing)
        return True

def addToLeftovers(newthing):
    myLeftovers.append(newthing)

#testing function and adding "DAD"
print(myUniqueList)
print(addToList("DAD"))
print(myUniqueList)
print(myLeftovers)

#adding same element to addToList
print(addToList("DAD")) #testing if it's False
print(myUniqueList)
print(myLeftovers)
